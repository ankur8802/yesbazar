...
<head>
    ...
    <title>YES BAZAR FINANCE LIMITED</title>
    <!-- Bootstrap -->
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-2 col-lg-2 col-md-12 col-sm-6 col-6">
                    <!-- logo -->
                    <div class="logo">
                        <a href="index.html"><img src="<?=base_url('assests')?>/images/mylogo.jpg" alt="Borrow - Loan Company Website Template"></a>
                    </div>
                </div>
                <!-- logo -->
                    ...
                    <div class="wrapper-content bg-white pinside40">
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"> <img src="<?=base_url('assests')?>/images/logo-1.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                                   ...
                                   <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                                        <div class="text-center">
                                            ...
                                            <small>Upfront fees</small> </div>
                                    </div>
                                   <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                                        <div class="text-center">
                                            <h3 class="compare-rate">5.54%</h3>
                                            <small>Comprasion rate*</small> </div>
                                    </div>
                                   <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                                        <div class="text-center">
                                            <h3 class="repayment">$200</h3>
                                            <small>Repayment</small> </div>
                                    </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"> <img src="images/logo-4.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                    <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-6">
                                        <div class="text-center">
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"> <img src="images/logo-3.jpg" alt="Borrow - Loan Company Website Template"> </div>
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"> <img src="images/logo-2.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                                        <div class="text-center">
                                            <h3 class="rate">3.52%</h3>
                                            <small>Variable</small> </div>
                        ...
                        <div class="compare-block mb30">
                            ...
                            <div class="compare-row outline pinside30">
                                <div class="row">
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-12 col-12"> <img src="images/logo-5.jpg" alt="Borrow - Loan Company Website Template"> </div>
                                    <div class="col-xl-2 col-lg-2 col-md-2 col-sm-6 col-6">
                                        <div class="text-center">
  ...
  <div class="footer section-space100">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                     <div class="widget-text mt40">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                <p class="call-text"><span><i class="icon-phone-call icon-1x"></i></span>9163309469</p>
                            </div>
                        </div>
                    </div>
                    <!-- /.widget text -->
                    ...
                    <div class="widget-footer mt40">
                        ...
                        <ul class="listnone">
                          ...
                          <!--   <li><a href="#">Services</a></li> -->
                            <li><a href="<?=base_url('index.php/Welcome/aboutus')?>">About Us</a></li>
                            <li><a href="<?=base_url('index.php/Welcome/news')?>">Privacy</a></li>
                             <li><a href="<?= base_url('index.php/Welcome/term')?>">Term & Condtion </a></li>
                           <!--  <li><a href="#">Faq</a></li> -->
                            <li><a href="<?=base_url('index.php/Welcome/eligibility')?>">Contact Us</a></li>
                        </ul>
                    </div>
                    <!-- /.widget footer -->
                </div>
                <div class="col-xl-2 col-lg-2 col-md-4 col-sm-6 col-6">
                    <div class="widget-footer mt40">
                        ...
                        <ul class="listnone"><!-- 
                            ...
                            <li><a href="<?=base_url('index.php/Welcome/personal')?>">Personal Loan</a></li>
                          <!--   <li><a href="#">Education Loan</a></li> -->
                            <li><a href="<?=base_url('index.php/Welcome/business')?>">Business Loan</a></li>
                            <li><a href="<?=base_url('index.php/Welcome/home')?>">Home Loan</a></li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6 text-right">
                     <p><a href="<?=base_url('index.php/Welcome/term')?>">Terms of use | Privacy Policy</a></p>
    ...
    <!-- Faq Accordion -->
    <script src="<?=base_url('assests')?>/js/accordion.js" type="text/javascript"></script>
    <script src="<?=base_url('assests')?>/../../../code.jquery.com/ui/1.12.1/jquery-ui.js"></script>
    <!-- Back to top script -->
