...
<head>
    ...
    <meta name="description" content="Check your Eligibility and apply for instant Business loan for starting your business. The 
interest will also be very affordable to bear for the customers.">
 <meta name="keywords" content="Personal loan ,Apply for personal loan,Personal loan apply online,Instant personal loan,Instant personal loan application,Instant personal loan online,home loan,Home loan online apply,Apply for home loan,Apply for home loan online,Car loan,Apply for car loan,Business loan,Apply for business loan,Business loan apply online,Loan against property">
     <title>Business Loan: Apply for Quick Business Loan And Get Upto 1 Crore</title>
    <!-- Bootstrap -->
   ...
   <link rel="stylesheet" type="text/css" href="<?=base_url('assests')?>/css/jquery-ui.css">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-5 col-md-4 col-sm-6 col-6 d-none d-xl-block d-lg-block">
                    <p class="mail-text">Welcome to our Yesh Loan Website Templates</p>
                </div>
                <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12 col-12 text-right">
                    <div class="top-nav"> <span class="top-text"><a href="#">View Locations</a> </span> <span class="top-text"><a href="#">+196742996217</a></span> <span class="top-text"><a href="#">EMI calculator</a></span> </div>
                </div>
            </div>
        </div>
    </div> -->
                            ...
                            <div class="col-xl-7 col-lg-7 col-md-8 col-sm-12 col-12">
                             ...
                             <div class="col-xl-4 col-lg-4 col-md-5 col-sm-12 col-12">
                                 ...
                                 <!--  <div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
                                        <div class="btn-action"> <a href="contact-us.php" class="btn btn-primary">Get a call back</a> <a href="#" class="btn btn-default">Emi Calculator</a> </div>
                                    </div> -->
                               <!--  </div>
                            </div>
                        </div>
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="wrapper-content bg-white">
                        <div class="section-scroll pinside60" id="section-about">
                            <h1 style="text-align: center;">About Business Loan</h1>
                            <p class="lead" style="line-height:24px; text-align:justify; font-family:Poppins, sans-serif; font-weight: 400px; font-size: 15px" >Business loan is <span>the obvious</span> choice if you need a finance for Business finance, Medical emergency, Wedding purposes, Abroad travel, Holidays, Child education and for buying consumer durable things. What is a Business loan? Business loan is a type of unsecured loan and helps you meet your current financial needs. You don’t usually need to pledge any security or collateral while availing a Businesss loan and your lender provides you with the flexibility to use the funds as per your need. It can serve as your solution for managing your travel costs and wedding expenses as well as the expenses of a medical emergency, renovation, debt consolidation and others. yes Bazar Finance Limited offers India’s fastest  loan with instant approval and disbursal within just 24 hours. Learn about your Business loan eligibility, use the  Loan EMI Calculator and apply for a loan in just four easy steps! Think it. Done with Yesh Bazar Finance Limited</p>
                        
                       <!--  <div class="col-lg-12" style="text-align: center;">

                             <a href="<?=base_url('index.php/eligibility')?>" class="btn btn-default">Apply for loan</a> </div> -->
                                ...
                                <div class="row">
                                   <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                        <div class="feature-blurb mb60">
                                            ...
                                            <p>Yesh Loan Company offers you personal loan for your unexpected medical emergency.Get instant personal loan for your all kind of medical emergency expenses.</p>
                                        </div>
                                    </div>
...
<section style="background-color: #c5c6c5;; padding-bottom: 50px;">
    <div class="container">
...
<div class="col-lg-2">
        ...
        <div class="col-lg-8">
            ...
            <h1 style="text-align: center; color: #f51f8a">Apply Now</h1>
...
<div class="form-group col-md-12 col-sm-12 col-12 col-name">
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                    <div class="footer-logo">
                        <!-- Footer Logo -->
                        <img src="<?=base_url('assests')?>/images/mylogo.jpg" alt="logo"> </div>
                    <!-- /.Footer Logo -->
                </div>
                    ...
                    <div class="widget-footer mt40">
                        ...
                        <ul class="listnone">
                           ...
                           <!--  <li><a href="#">Education Loan</a></li> -->
                            ...
                            <li><a href="<?= base_url('home')?>">Home Loan</a></li>
    ...
    <!-- slider script -->
    <script type="text/javascript" src="<?=base_url('assests')?>/js/owl.carousel.min.js"></script>
    <script type="text/javascript" src="<?=base_url('assests')?>/js/slider-carousel.js"></script>
    <script type="text/javascript" src="<?=base_url('assests')?>/js/service-carousel.js"></script>
    <!-- Back to top script -->
...
<?php
 if($this->session->flashdata('insertquery_alt'))
 {
 ?>
